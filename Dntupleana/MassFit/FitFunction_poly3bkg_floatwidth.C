...
TF1* fit_histo_poly3bkg_floatwidth( bool isPbPb, int centlow, int centhigh, TH1D * histo, TH1D * h_mc_matched_signal, TH1D * h_mc_matched_kpiswapped, int ipt, TString cfgname, bool SavePdfplot = true, bool get_sig_bkg_ratio = false, TH1D * Ratio_signal_foreground = NULL, bool effcorrected = false)
{
	...
	TCanvas* cfg= new TCanvas(Form("cfg_poly3bkg_floatwidth_%s_%d",cfgname.Data(),ipt),Form("cfg_poly3bkg_floatwidth_%s_%d",cfgname.Data(),ipt),600,600);
	...
	background->SetParameter(3,f->GetParameter(11));
	...
	if(isPbPb)
	{
		if( SavePdfplot ) cfg->SaveAs(Form("Massfitplots/PbPb/DMass_isPbPb%d_%s_cent%dto%d_%d_poly3bkg_floatwidth.pdf", isPbPb, cfgname.Data(), centlow, centhigh, ipt));
	...
	{
		if( SavePdfplot ) cfg->SaveAs(Form("Massfitplots/pp/DMass_isPbPb%d_%s_cent%dto%d_%d_poly3bkg_floatwidth.pdf", isPbPb, cfgname.Data(), centlow, centhigh, ipt));
