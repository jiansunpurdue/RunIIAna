...
InputDefault="rootfiles/vn_vnvsmass_MBtrig_SP_cent${cent_low}to${cent_high}_poly3bkg_floatwidth.root"
InputPoly2bkg="rootfiles/vn_vnvsmass_MBtrig_SP_cent${cent_low}to${cent_high}_poly2bkg_floatwidth.root"
InputExpobkg="rootfiles/vn_vnvsmass_MBtrig_SP_cent${cent_low}to${cent_high}_expobkg_2nd_floatwidth.root"
