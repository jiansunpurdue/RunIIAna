...
void MassFit_combmassvnFit(string inputdatafilename = "./../rootfiles_default/anaDntuple_Dntuple_crab_PbPb_HIMinimumBias1to7_ForestAOD_D0y1p1_tkpt0p7eta1p5_goldenjson_EvtPlaneCali_03182015_Cent50to70.root", string inputmcfilename = "./../rootfiles_default/anaDntuple_ntD_EvtBase_20160513_DfinderMC_PbPb_20160502_dPt1tkPt0p5_D0_prompt_Dpt2Dy1p1tkPt0p7tkEta2Decay2p9Dalpha0p14Skim_pthatweight_Cent-0to100_Evt0to-1.root", TString MBorDtrig = "MBtrig", TString EPorSP = "SP", int iptstart = 10, int iptend = 11, bool isPbPb = true, int centlow=50, int centhigh=70, TString fitoption = "poly3bkg_floatwidth", bool effcorrected = false)
{
	TH1::SetDefaultSumw2();
