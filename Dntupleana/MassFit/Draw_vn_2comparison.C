...
void Draw_vn_2comparison(TString input_1= "rootfiles_Data/vn_combinedfit_vnvsmass_MBtrig_SP_cent30to50_poly3bkg_floatwidth_effcorrected0.root", TString input_vnvmass_SP = "rootfiles_Data_DCAcut0p008/vn_combinedfit_vnvsmass_MBtrig_SP_cent30to50_poly3bkg_floatwidth_effcorrected0.root", TString input_v2_1name = "h_v2_pt", TString input_v3_1name = "h_v3_pt", TString input_v2_2name = "h_v2_pt", TString input_v3_2name = "h_v3_pt", TString str_legend1 = "w/o DCA Cut", TString str_legend2 = "DCA < 0.008 cm", TString cfgname = "DCAcut", TString trigname = "MBtrig", int cent_low = 30, int cent_high = 50, double ptlow = 0.0, double pthigh = 40.0)
{
	TH1::SetDefaultSumw2();
