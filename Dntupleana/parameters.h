...
float ptbins[Nptbin+1]   =      { 0.0, 0.5, 1.0, 2.0, 3.0, 4.0, 6.0, 8.0, 12.0, 16.0, 25.0, 35.0, 45.0, 65.0, 100.0, 200.0};

float vertex3dcut_PbPb[Nptbin] = {6.0, 6.0, 6.0, 5.86, 5.86, 4.86, 4.54, 4.42, 4.06, 3.50, 3.0, 3.0,  3.0,  3.0,  3.0};
float alphacut_PbPb[Nptbin]  = {0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12, 0.12};
float vertexprobcut_PbPb[Nptbin] = {0.25, 0.25, 0.25, 0.224, 0.224, 0.170, 0.125, 0.091, 0.069, 0.054, 0.05, 0.05, 0.05, 0.05, 0.05};
